...
// the GitHub Releases API for malcolmston/axios.
const RELEASE_LIBS: RelLib[] = [
  { name: AXIOS.name, icon: AXIOS.icon, accent: AXIOS.accent, repo: ghrepo(AXIOS), url: AXIOS.repo },
];
